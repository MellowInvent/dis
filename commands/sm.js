...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        if (currentCooldown === time) return message.channel.send(`yes i wil tottally change the slowmode thats the same r u twelve or somethin slowmmode is alreay S\`${args[0]}\``).then(m => m.delete({ timeout: 5000 }));
